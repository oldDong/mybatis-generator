...
import com.itfsw.mybatis.generator.plugins.SelectOneByExamplePlugin;
...
public class SelectSelectivePlugin extends BasePlugin {
    public static final String METHOD_SELECT_BY_EXAMPLE_SELECTIVE = "selectByConditionSelective";
    public static final String METHOD_SELECT_BY_PRIMARY_KEY_SELECTIVE = "selectByPrimaryKeySelective";
    public static final String METHOD_SELECT_ONE_BY_EXAMPLE_SELECTIVE = "selectOneByConditionSelective";
    ...
    public boolean validate(List<String> warnings) {
        ...
        if (!PluginTools.checkDependencyPlugin(getContext(), ModelColumnPlugin.class)) {
            warnings.add("itfsw:插件com.hellomrpc.mybatis.generator.plugins.SelectSelectivePlugin插件需配合com.itfsw.mybatis.generator.plugins.ModelColumnPlugin插件使用！");
            return false;
        }
